      ...
      <div className="space-y-0">
        ...
        <section className="py-5 border-b border-border/60">
          ...
          <div className="space-y-2 text-muted-foreground leading-relaxed">
            <p>
              기술을 학습하는데 있어 빠른 습득 속도를 자부합니다. 교육 과정이나 업무 실적에서 중상 이상을
              달성해왔습니다.
            </p>
            <p>개발의 시작은 Java로 시작하였지만, 현재는 Next.js, Typescript, Prisma를 가장 잘 사용합니다.</p>
            <p>
              판매사·공급사·어드민 다중 플랫폼 설계·개발 경험과 멀티테넌트 기반 다중 도메인 플랫폼 개발 경험이 있습니다.
              안드로이드 Kotlin(Jetpack Compose) 개발 능력이 있으며, Vanilla JS만으로도 웹 개발이 가능합니다. PHP 환경을
              React, Remix.js 환경으로 마이그레이션한 경험이 있습니다.
            </p>
          </div>
        </section>
        ...
        <section className="py-5">
          ...
          <p className="text-muted-foreground leading-relaxed">
            기술을 통해 사람들의 일상을 더 편리하게 만드는 것이 목표입니다. 복잡한 문제를 단순하게, 어려운 기술을 쉽게
            전달하며 함께 성장하는 개발 문화를 만들어가고자 합니다.
          </p>
        </section>
      </div>
    </PageContainer>
