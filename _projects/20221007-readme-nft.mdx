...
블록체인과 실시간 통신이라는 두 가지 도전적인 기술을 동시에 다룬 프로젝트입니다. Socket.io를 활용한 실시간 캔버스 동기화와 채팅 정답 판별 로직 구현이 기술적으로 가장 흥미로웠고, Web3.js를 통해 프론트엔드에서 직접 스마트 컨트랙트와 상호작용하는 경험을 쌓았습니다.
