...
SSAFY 관통 프로젝트로 Vue.js와 Spring Boot를 연동한 첫 풀스택 프로젝트입니다. JWT 인증을 백엔드(인터셉터·토큰 검증)부터 프론트엔드(라우터 가드·헤더 주입)까지 직접 구현하며 인증 플로우 전체를 관통하는 경험을 쌓았고, YouTube API·Kakao Map API 연동과 Vuex 상태 관리로 SPA 아키텍처의 기본기를 익혔습니다.
