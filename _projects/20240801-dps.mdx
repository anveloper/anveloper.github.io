...
16개의 스케줄된 배치 작업이 플랫폼 운영을 자동화합니다.
...
- **카카오 알림톡**: 주문·배송 알림 발송 (Lunasoft 연동)
- **Innopay**: PG 결제 처리
...
- 관리자·판매자·스토어 3개 역할 통합 플랫폼 구축 (200개 이상 페이지)
- 16개 배치 작업 자동화로 수작업 운영 비용 절감
