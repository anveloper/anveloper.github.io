...
tags: ["Next.js", "React", "TypeScript", "Prisma", "MySQL", "Zustand", "TanStack Query", "NextAuth", "Tailwind CSS", "AWS S3"]
---
...
- **Jarvis(CIPOD)**: 디자인 에디터 연동 + Jarvis 계정 기반 SSO 로그인·토큰 갱신
...
components/         # 재사용 컴포넌트
services/           # 비즈니스 로직 (29개 도메인 — order, settle, jarvis, filebot, external 등)
lib/
...
사내 팀 개발 프로젝트이며, 전체 커밋 약 8,900건 중 절반가량을 담당한 주 기여자로 참여했습니다.
