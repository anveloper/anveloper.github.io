...
tags: ["React", "Redux", "Material-UI", "OpenVidu", "Spring Boot", "JPA", "MySQL", "Redis"]
...
| 분류        | 기술                                                        |
| ----------- | ----------------------------------------------------------- |
| Frontend    | React 18, JavaScript, Redux Toolkit, Material-UI 5, Emotion |
