...
date: "2022-11-21"
category: "ssafy"
period: "2022.10 ~ 2022.11 (약 7주)"
team: "6인"
contribution: "Android 앱 개발 담당"
role: "Android"
...
NAYA는 "NA(나)를 소개하는 가장 쉬운 방법"이라는 콘셉트의 소개 카드 관리 서비스입니다. 멀티미디어 소개 카드(Naya)와 명함(Business Card)을 제작하고, QR코드·카카오톡·Instagram 스토리 등 다양한 채널로 공유할 수 있습니다.
...
flowchart TD
  ...
  Android -->|"QR · 카카오 · Instagram"| Share["카드 공유"]
  Share --> Web
```
...
특히 QR코드·카카오톡·Instagram 스토리라는 서로 다른 공유 채널을 하나의 일관된 플로우로 통합한 설계와, Room DB를 활용한 로컬 우선 아키텍처가 오프라인 환경에서도 원활한 사용 경험을 제공하는 데 기여했습니다.
